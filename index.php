...
<body>
    <h1 class="text-center p-3">Lista de Alumnos</h1>
    <?php
    ...
    <div class="container-fluid row">
        <form class="col-4" method="POST">
            <h3 class="text-center p-3">Registro de Alumnos</h3>
  ...
  if ($sql) {
      while($datos=$sql->fetch_object()) {?>
          <tr>
          <th><?= $datos->alumno_id ?></th>
          <td><?= $datos->nombres ?></td>
          <td><?= $datos->ape_paterno ?></td>
          <td><?= $datos->ape_materno ?></td>
          <td>
              <a href="modificar_alumno.php?alumno_id=<?= $datos->alumno_id ?>" class="btn btn-small btn-warning">Editar</a>
              <a href="index.php?alumno_id=<?= $datos->alumno_id ?>" class="btn btn-small btn-danger">Eliminar</a>
        </td>
      </tr>
      <?php }
  } else {
