...
$sql=$conexion->query("select * from profesor where profesor_id='$profesor_id'");
...
<body>
    <form class="col-4 p-3 m-auto" method="POST">
        <h3 class="text-center alert alert-secondary p-3">Modificar profesores</h3>
        <input type="hidden" name="profesor_id" value="<?= $_GET["profesor_id"] ?>">
        <?php
        include "controlador_profesor/modificar_profesor.php";
